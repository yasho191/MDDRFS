...
function DiseaseDetection() {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("test_type", "disease detection");
    ...
    const response = await fetch("/api/doctors/upload_scan/disease_detection", requestOptions);
    setLoading(false);
    if (!response.ok) {
        ...
        <section style={{margin: "1% 5% 2% 5%"}}>
          ...
          <Container className="d-flex" style={{ minHeight: "80vh"}}>
            <Row className="align-items-center">
              ...
              <Col md={6}>
                <Image src={"/images/disease_detection_model.png"} alt="Your Image" fluid style={{ "max-width": "auto", "height": "auto"}} roundedCircle/>
              </Col>
            </Row>
          </Container>
        </section>
